...
import (
	...
	"github.com/crossplane-contrib/function-hcl/function-hcl/internal/fn"
...
func main() {
	ctx := kong.Parse(&CLI{}, kong.Description("A crossplane function that allows scripts written in a DSL based on HCL to compose resources"))
